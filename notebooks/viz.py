...
args = {"backbone_name": "vinai/bertweet-covid19-base-cased", "num_labels": 16, "tokenizer_name": "roberta-base", "batch_size":32, "load_classifier": None}
args = Namespace(**args)
model = TextCLSLightningModule.load_from_checkpoint(ckpt_path, args=args)

eb_model = AutoModel.from_pretrained("vinai/bertweet-covid19-base-cased")
